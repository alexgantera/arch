...
pacman -S ttf-dejavu ttf-liberation ttf-sazanami unrar xclip xorg-xrandr xreader yay youtube-dl zim --noconfirm
...
GRUB_CMDLINE_LINUX_DEFAULT="loglevel=3 quiet modprobe.blacklist=iTCO_wdt radeon.si_support=0 amdgpu.si_support=1"
GRUB_CMDLINE_LINUX=""
GRUB_FONT=/boot/grub/ter-u16b.pf2
...
echo " "
echo "Добавление модулей в mkinitcpio.conf "
echo "# vim:set ft=sh
# MODULES
